// The aurora background's drawing, independent of React: <AuroraLayer> drives
// it through ./auroraRenderer.js. A copy of src/lib/auroraScene.js in the app
// (where it also runs in a worker with an OffscreenCanvas); keep the two in
// sync. Everything the frame loop needs is set up front or pushed in through
// setters, so the per-frame work is the drawing itself.
//
